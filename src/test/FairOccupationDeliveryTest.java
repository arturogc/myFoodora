...
public class FairOccupationDeliveryTest extends TestCase{
	...
	public FairOccupationDeliveryTest() {
	...
	public void setUp() throws Exception {
		...
		try {
			Restaurant restaurant = new Restaurant(null, "resto du love", "resto1", "azerty", new Point2D.Double(5,8));
	...
	public void testAllocateCourier() {
		...
		couriers.get(1).setDeliveredOrders(5);
		couriers.get(2).setDeliveredOrders(1);
		couriers.get(3).setDeliveredOrders(10);
		Courier courier = deliveryPolicy.allocateCourier(order, couriers);
		assertEquals("Not fair Allocation", courier, couriers.get(2));
